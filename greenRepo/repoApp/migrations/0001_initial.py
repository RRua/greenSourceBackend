# Generated by Django 2.1 on 2018-09-05 16:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_description', models.CharField(default=None, max_length=96, null=True)),
                ('app_language', models.CharField(max_length=32)),
                ('app_build_tool', models.CharField(max_length=16)),
                ('app_version', models.FloatField(default=1)),
                ('app_flavor', models.CharField(default='', max_length=32)),
                ('app_build_type', models.CharField(default='gradle', max_length=16)),
            ],
        ),
        migrations.CreateModel(
            name='AppMetric',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_non_acc_mod', models.CharField(default='', max_length=24, null=True)),
                ('class_acc_modifier', models.CharField(max_length=16)),
                ('class_superclass', models.CharField(default='', max_length=64, null=True)),
                ('class_is_interface', models.BooleanField(default=False)),
                ('class_implemented_ifaces', models.CharField(default='', max_length=256)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('class_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='classofimport', to='repoApp.Class')),
            ],
        ),
        migrations.CreateModel(
            name='ClassMetric',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('import_desc', models.CharField(max_length=32)),
            ],
        ),
        migrations.CreateModel(
            name='Method',
            fields=[
                ('method_id', models.CharField(max_length=256, primary_key=True, serialize=False)),
                ('method_name', models.CharField(max_length=256)),
                ('method_non_acc_mod', models.CharField(max_length=24)),
        ...
        migrations.AddField(
            ...
            name='class_imp',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='importofclass', to='repoApp.Import'),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='classhasimport',
            unique_together={('class_id', 'class_imp')},
        ),
        migrations.AlterUniqueTogether(
            name='appmetric',
