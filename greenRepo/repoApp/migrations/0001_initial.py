# Generated by Django 2.1.2 on 2019-02-15 15:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_non_acc_mod', models.CharField(blank=True, default='', max_length=32)),
                ('class_acc_modifier', models.CharField(blank=True, default='', max_length=16)),
                ('class_superclass', models.CharField(blank=True, default='', max_length=64)),
                ('class_is_interface', models.BooleanField(default=False)),
                ('class_implemented_ifaces', models.CharField(blank=True, default='', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_results_description', models.CharField(blank=True, default='', max_length=100, null=True)),
                ('test_results_api_level', models.FloatField(default=None, null=True)),
                ('test_results_android_version', models.CharField(blank=True, default=None, max_length=8, null=True)),
        ...
        migrations.AddField(
            model_name='methodmetric',
            name='mm_test',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mmmtest', to='repoApp.TestResults'),
        ),
        migrations.AddField(
